...
class MockAdapter(OBDAdapter):
    ...
    def _validate_packet(packet: DataPacket) -> None:
        from autopulse.data.validator import validate_frame
...
class EVMockAdapter(OBDAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        from autopulse.data.validator import UDSCommandGuard
    ...
    def fetch_frame(self) -> EVDataPacket:
        from autopulse.data.validator import route_and_validate
    ...
    def _enforce_security(self, row: dict[str, Any]) -> None:
        from autopulse.data.validator import CommandBlockedException
