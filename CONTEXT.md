...
*   Local implementation verification: workflow contract `2 passed`; full Python suite `647 passed`; Starlight build passed; smoke `6 passed, 2 skipped`; docs regression `48 passed, 2 skipped`. Final Claude audit prompt is `docs/prompts/claude-pr-004-actions-v7-final-implementation-audit.md`; eight hosted release cells and docs job are still required before merge readiness.
